...
RCT_EXPORT_METHOD(getStepCountBetweenDates:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
{
    [self fitness_getStepCountBetweenDates:input callback:callback];
}
